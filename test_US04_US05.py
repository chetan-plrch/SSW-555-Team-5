...
class MyTestCase(unittest.TestCase):
    ...
    def test_US05_1(self):
        ...
        print('US04 Test Case #1 - Passed: Marriage date and death date are not present')
    ...
    def test_US05_2(self):
        ...
        print('US04 Test Case #3 - Passed: Marriage date is present and death date is not present')

    def test_US05_3(self):
        self.assertIsNone(parse.check_if_married_before_death('-', '01 FEB 1995'))
        print('US04 Test Case #2 - Passed: Marriage date is present and divorce date is not present')
    ...
    def test_US05_4(self):
        self.assertEqual(parse.check_if_married_before_death(datetime.datetime.strptime('1995-01-12', '%Y-%d-%m').date(), '01 JAN 1995'),
                         'ERROR: US04: Marriage date cannot be after death date')
        print('US04 Test Case #4 - Passed: Marriage date cannot be after death date')
    ...
    def test_US05_5(self):
        self.assertEqual(parse.check_if_married_before_death(datetime.datetime.strptime('1995-01-12', '%Y-%d-%m').date(), '01 DEC 1995'),
                         'ERROR: US04: Marriage date cannot be equal to death date')
        print('US04 Test Case #5 - Passed: Invalid Scenario - ERROR: US04: Marriage date cannot be equal to death date')
    ...
    def test_US05_6(self):
        ...
        print('US04 Test Case #5 - Passed: Valid Scenario - Marriage date is before death date')
